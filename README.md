...
|      | [항목24 타입 변환이 모든 매개변수에 대해 적용되어야 한다면 비멤버 함수를 선언하자](./Chapter4%20설계%20및%20선언/항목24%20타입%20변환이%20모든%20매개변수에%20대해%20적용되어야%20한다면%20비멤버%20함수를%20선언하자/항목24%20타입%20변환이%20모든%20매개변수에%20대해%20적용되어야%20한다면%20비멤버%20함수를%20선언하자.md)                                                      | Hi-MuMu         |
...
| 챕터 | 항목                                                                                                                                                                                                                                                                                                                             | 작성자          |
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| 5    | [항목26 변수 정의는 늦출 수 있는 데까지 늦추는 근성을 발휘하자](./Chapter5%20구현/항목26%20변수%20정의는%20늦출%20수%20있는%20데까지%20늦추는%20근성을%20발휘하자/항목%2026%20변수%20정의는%20늦출%20수%20있는%20데까지%20늦추는%20근성을%20발휘하자%20-%20작성자%20권우현.md) | WooHyunKwon1012 |
...
|      | [항목29 예외 안전성이 확보되는 그날 위해 싸우고 또 싸우자!](./Chapter5%20구현/항목29%20예외%20안전성이%20확보되는%20그날%20위해%20싸우고%20또%20싸우자!/항목%2029%20예외%20안전성이%20확보되는%20그날%20위해%20싸우고%20또%20싸우자!.md)                                                                                         | YE7283          |
...
| 챕터 | 항목                                                                                                                                                                                                                                                                                                                                                                 | 작성자          |
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| 6    | [항목32 public 상속 모형은 반드시 is-a를 따르도록 만들자](<./Chapter6%20상속,%20그리고%20객체%20지향%20설계/항목32%20public%20상속%20모형은%20반드시%20is-a를%20따르도록%20만들자/항목%2032%20public%20상속%20모형은%20반드시%20“is%20-%20a(…는%20…의%20일종이다)”를%20따르도록%20만들자-%20작성자%20권우현.md>)     | WooHyunKwon1012 |
...
|      | [항목35 가상 함수 대신 쓸 것들도 생각해 두는 자세를 시시때때로 길러 두자](./Chapter6%20상속,%20그리고%20객체%20지향%20설계/항목35%20가상%20함수%20대신%20쓸%20것들도%20생각해%20두는%20자세를%20시시때때로%20길러%20두자/항목%2035%20가상%20함수%20대신%20쓸%20것들도%20생각해%20두는%20자세를%20시시때때로%20길러%20두자.md)                                        | YE7283          |
...
| 챕터 | 항목                                                                                                                                                                                                                                                                                                                                                      | 작성자          |
| ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| 6    | [항목38 has-a 혹은 is-implemented-in-terms-of를 모형화할 때는 객체 합성을 사용하자](<./Chapter6%20상속,%20그리고%20객체%20지향%20설계/항목38%20has-a%20혹은%20is-implemented-in-terms-of를%20모형화할%20때는%20객체%20합성을%20사용하자/항목%2038%20“has-a(…는%20…를%20가짐)”%20혹은%20“is-implemented-in-term.md>)                        | WooHyunKwon1012 |
...
| 7    | [항목41 템플릿 프로그래밍의 천릿길도 암시적 인터페이스와 컴파일 타임 다형성부터](./Chapter7%20템플릿과%20일반화%20프로그래밍/항목41%20템플릿%20프로그래밍의%20천릿길도%20암시적%20인터페이스와%20컴파일%20타임%20다형성부터/항목%2041%20템플릿%20프로그래밍의%20천릿길도%20암시적%20인터페이스와%20컴파일%20타임%20다형성부터.md)                         | YE7283          |
...
|      | [항목47 타입에 대한 정보가 필요하다면 특성정보 클래스를 사용하자](./Chapter7%20템플릿과%20일반화%20프로그래밍/항목47%20타입에%20대한%20정보가%20필요하다면%20특성정보%20클래스를%20사용하자/항목%2047%20타입에%20대한%20정보가%20필요하다면%20특성정보%20클래스를%20사용하자.md)                                                                       | YE7283       |
|      | [항목48 템플릿 메타프로그래밍, 하지 않겠는가?](./Chapter7%20템플릿과%20일반화%20프로그래밍/항목48%20템플릿%20메타프로그래밍,%20하지%20않겠는가/항목48%20템플릿%20메타프로그래밍,%20하지%20않겠는가.md)                                                                                                                                                 | Hi-MuMu      |
| 8    | [항목49 new 처리자의 동작 원리를 제대로 이해하자](./Chapter8%20new와%20delete를%20내%20맘대로/항목49%20new%20처리자의%20동작%20원리를%20제대로%20이해하자/항목%2049%20new%20처리자의%20동작%20원리를%20제대로%20이해하자%20-%20작성자%20한지윤.md)                                                                                                     | han-skyler   |
...
| 챕터 | 항목                                                                                                                                                                                                                                                                                                                | 작성자       |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| 8    | [항목50 new 및 delete를 언제 바꿔야 좋은 소리를 들을지를 파악해 두자](./Chapter8%20new와%20delete를%20내%20맘대로/항목50%20new%20및%20delete를%20언제%20바꿔야%20좋은%20소리를%20들을지를%20파악해%20두자/항목%2050%20new%20및%20delete를%20언제%20바꿔야%20좋은%20소리를%20들을지를%20파악해%20두자.md)            | YE7283       |
...
|      | [항목52 위치지정 new를 작성한다면 위치지정 delete도 같이 준비하자](./Chapter8%20new와%20delete를%20내%20맘대로/항목52%20위치지정%20new를%20작성한다면%20위치지정%20delete도%20같이%20준비하자/항목%2052%20위치지정%20new를%20작성한다면%20위치지정%20delete도%20같이%20준비하자.md)                                 | corlexvusR   |
| 9    | [항목53 컴파일러 경고를 지나치지 말자](./Chapter9%20그%20밖의%20이야기들/항목53%20컴파일러%20경고를%20지나치지%20말자/항목%2053%20컴파일러%20경고를%20지나치지%20말자.md)                                                                                                                                           | YE7283       |
|      | [항목54 TR1을 포함한 표준 라이브러리 구성요소와 편안한 친구가 되자](./Chapter9%20그%20밖의%20이야기들/항목54%20TR1을%20포함한%20표준%20라이브러리%20구성요소와%20편안한%20친구가%20되자/항목54%20TR1%20을%20포함한%20표준%20라이브러리%20구성요소와%20편안한%20친구가%20되자%20-%20작성자%20서무성.md)              | Hi-MuMu      |
|      | [항목55 부스트를 늘 여러분 가까이에](./Chapter9%20그%20밖의%20이야기들/항목55%20부스트를%20늘%20여러분%20가까이에/항목%2055%20Boost를%20늘%20여러분%20가까이에%20-%20작성자%20한지윤.md)                                                                                                                            | han-skyler   |
